...
<sub>Adapted from the `SEO Optimizer` skill via [claude-code-templates](https://github.com/davila7/claude-code-templates) (aitmpl.com). See the source's LICENSE for original terms.</sub>
